...
export default function Home(){
  ...
  function MobileMenu() {
    ...
    return (
      <div className="md:hidden mt-4 p-4 bg-white border rounded-lg shadow-sm">
        <nav className="flex flex-col gap-3">
          <a href="#projects" onClick={() => setMenuOpen(false)} className="text-sm hover:underline">Projects</a>
          <a href="#research" onClick={() => setMenuOpen(false)} className="text-sm hover:underline">Research</a>
          <a href="#skills" onClick={() => setMenuOpen(false)} className="text-sm hover:underline">Skills</a>
          <a href="#about" onClick={() => setMenuOpen(false)} className="text-sm hover:underline">About</a>
          <a href="mailto:axitpatel1705@gmail.com" onClick={() => setMenuOpen(false)} className="inline-block text-sm mt-2 px-3 py-2 bg-emerald-600 text-white rounded-md">Contact</a>

          <div className="flex items-center gap-4 mt-3 text-gray-600">
            <a href="https://wa.me/919924678435" target="_blank" rel="noreferrer" className="hover:text-emerald-600" aria-label="WhatsApp">
              <PhoneIcon size={18} />
            </a>
            <a href="https://www.linkedin.com/in/axit-pankajbhai-patel-0a842b239" target="_blank" rel="noreferrer" className="hover:text-emerald-600" aria-label="LinkedIn">
              <LinkedinIcon size={18} />
            </a>
            <a href="https://www.instagram.com/_itsakky1310_" target="_blank" rel="noreferrer" className="hover:text-emerald-600" aria-label="Instagram">
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900 antialiased">
      ...
      <header className="max-w-6xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-bold text-lg md:text-xl">AP</div>
            <div>
              <h1 className="text-lg md:text-2xl font-extrabold">Axit Pankajbhai Patel</h1>
              <p className="text-xs md:text-sm text-gray-600">Full-Stack Engineer • Researcher • Open-Source Contributor</p>
            </div>
          </div>

          {/* right: desktop nav + contact (hidden on small), and hamburger (visible on small) */}
          <div className="flex items-center gap-4">
            ...
            {/* socials - hide on very small screens, show on md */}
            <div className="hidden md:flex items-center gap-3 ml-2 text-gray-600">
              <a href="https://wa.me/919924678435" target="_blank" rel="noreferrer" className="hover:text-emerald-600" aria-label="WhatsApp">
                <PhoneIcon size={18} />
              </a>
              <a href="https://www.linkedin.com/in/axit-pankajbhai-patel-0a842b239" target="_blank" rel="noreferrer" className="hover:text-emerald-600" aria-label="LinkedIn">
      ...
      {/* rest of your page (kept as-is, trimmed here for clarity) */}
